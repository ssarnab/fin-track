...
export default function VerifyEmail() {
  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-bg px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-border bg-surface p-8 shadow-(--shadow-lg) text-center">
        <div className="mx-auto mb-4 grid h-11 w-11 place-items-center rounded-xl bg-primary text-primary-fg font-semibold text-lg shadow-(--shadow)">
          ৳
        </div>
